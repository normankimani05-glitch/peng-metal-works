...
export function AboutSection() {
  return (
    <section id="about" className="py-16 md:py-24 bg-white border-y">
      <div className="container">
        {/* Intro */}
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-balance font-bold text-2xl sm:text-3xl md:text-4xl mb-4 sm:mb-6 text-primary">Who We Are</h2>
          <p className="text-pretty text-base sm:text-lg text-foreground/80 leading-relaxed max-w-prose mx-auto">
          ...
          <p className="text-pretty text-sm sm:text-base text-primary font-medium mt-5 sm:mt-6 italic">
        ...
        <div className="mt-12 md:mt-14 grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
          <div className="rounded-xl border-2 border-accent bg-white p-5 sm:p-6 shadow-sm hover:shadow-lg">
            <h3 className="font-semibold text-xl text-foreground mb-2">Our Mission</h3>
            <p className="text-sm sm:text-base text-foreground/80 leading-relaxed">
              To deliver world-class fabrication services that combine innovation, strength, and precision. Hence providing
        ...
        <div className="mt-14 md:mt-16">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-foreground/80 mt-3 max-w-prose mx-auto">
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div className="rounded-xl border-2 border-accent bg-white p-5 sm:p-6 shadow-sm hover:shadow-lg transition-all">
              ...
              <p className="text-sm text-foreground/80 mt-3">
                Tailor-made engineering and fabrication solutions built to client specifications.
              </p>
              <p className="text-pretty text-base text-primary font-medium mt-3 italic">
